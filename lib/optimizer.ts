...
function createOptimizedPrompt(original: string, role: string, objective: string, reasoning: string, language: string): string {
  ...
  // Mejorar la instrucción original
  ...
  // Añadir especificaciones de idioma
  ...
  // Añadir instrucciones de razonamiento
  if (reasoning === 'high') {
  ...
  // Añadir constraints por objetivo
  switch (objective) {
    case 'precision':
...
// =====================================================
// components/HomeClient.tsx - SOLO ARREGLAR ERRORES CRÍTICOS
// =====================================================
